...
SystemdD_Setup() {
  ...
  sed -i -e 's/MONGO_DNSNAME/mongodb.roboshop.internal/' -e 's/REDIS_ENDPOINT/redis.roboshop.internal/' -e  's/MONGO_ENDPOINT/mongodb.roboshop.internal/' -e 's/CATALOGUE_ENDPOINT/catalogue.roboshop.internal/'  's/USERHOST/user.roboshop.internal/' 's/CARTHOST/cart.roboshop.internal/'  /home/roboshop/${COMPONENT}/systemd.service
  Status_Check $?
